<template>
  <div class="side-setting">
    <setting-item>
      ...
      <a-button type="dashed" icon="redo" style="float: right" @click="resetSetting">
        {{ $t('reset') }}
      </a-button>
    </setting-item>
    ...
    <setting-item :title="$t('theme.color')">
      <color-checkbox-group
        ...
        :multiple="false" @change="(values, colors) => setTheme({...theme, color: colors[0]})"
      >
      ...
      <a-list :split="false">
        <!-- <a-list-item>
          ...
          <a-select
            ...
            :value="pageWidth"
            class="select-item" size="small" @change="setPageWidth"
          >
      ...
      <a-list :split="false">
        ...
        <a-list-item>
          ...
          <a-select
            ...
            :value="animate.name"
            :get-popup-container="getPopupContainer"
            class="select-item" size="small" @change="val => setAnimate({...animate, name: val})"
          >
        ...
        <a-list-item>
          ...
          <a-select
            ...
            :get-popup-container="getPopupContainer"
            class="select-item" size="small" @change="val => setAnimate({...animate, direction: val})"
          >
